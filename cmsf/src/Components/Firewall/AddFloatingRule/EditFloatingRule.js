      ...
      AxiosInstance.post(`gettempfrules`, {
        ...
        if (res.data.success === true) {
          setInitialValues({
            ...
            quick: res.data.tempfrule.quick,
            interface: res.data.tempfrule.interface,
            direction: res.data.tempfrule.direction,
        ...
        .then((res) => {
          if (res.data.success === true) {
            setInitialValues({
              ...
              quick: res.data.frule.quick,
              interface: res.data.frule.interface,
              direction: res.data.frule.direction,
                  ...
                  <div className="checkbox col-sm-10">
                    <label className="chkboxlbl">
                      <input
                        ...
                        onChange={(e) => {
                          let temp = { ...initialValues };
                          temp.disableReplyTo = e.target.checked;
                          setInitialValues(temp);
                        }}
                      />
...
export default EditFloatingRule;
